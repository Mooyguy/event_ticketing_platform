...
//   const trendingEvents = useMemo(() => {
//     return [...events].sort((a, b) => Number(a.price) - Number(b.price)).slice(0, 6);
//   }, [events]);
...
//               <div className="mb-6">
//                 <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">
//                   {hasActiveFilters ? "Filtered Results" : "Browse All Events"}
//                 </h2>

//                 <p className="mt-2 text-slate-600">
//                   {hasActiveFilters
//                     ? "Matching events are shown here first based on your search and selected filters."
//                     : "Explore available events across categories and cities."}
//                 </p>
//               </div>
